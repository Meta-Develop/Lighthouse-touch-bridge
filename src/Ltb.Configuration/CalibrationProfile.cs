...
/// model, schema-2 driver profile, and optional runtime controller identity.
...
public sealed record CalibrationProfile
{
    ...
    /// <summary>Constructs a schema-2 profile with an explicit driver identity.</summary>
    public CalibrationProfile(
        int schemaVersion,
        string profileName,
        ControllerHand hand,
        ...
        bool driverProfileIsExplicit)
    {
        ...
        ControllerIdentity = ProfileValidation.OptionalIdentity(controllerIdentity, nameof(controllerIdentity));
    ...
    /// <summary>
    /// Optional identity reported by the controller runtime. Schema 1 serialized
    /// this value as <c>controller_serial</c>; schema 2 uses
    /// <c>controller_identity</c> because it need not be a hardware serial.
    /// </summary>
    ...
    /// with a schema-2 profile. Legacy profiles always return false.
    /// </summary>
