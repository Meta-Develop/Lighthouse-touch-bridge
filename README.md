...
LTB is in pre-implementation development. The product and implementation specification is complete, while runtime integrations, calibration algorithms, and the application UI remain to be built.
